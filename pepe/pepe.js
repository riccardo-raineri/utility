...
/* ══════════════════════════════════════════════════════════
   ...
   (Si attiva se è presente il container #full-catalogo-grid)
   ══════════════════════════════════════════════════════════ */
  ...
  for (const [id, p] of Object.entries(PRODOTTI)) {
    ...
    html += `
      <div class="cat-card reveal in">
        <div class="cat-photo"><img src="${thumb}" alt="${p.name}" loading="lazy"></div>
        <div class="cat-info">
          ...
          <div class="cat-footer">
            ...
            <button class="cat-buy-btn" data-id="${id}">Personalizza</button>
          </div>
        </div>
      </div>
    `;
...
// Delegazione degli eventi per aprire il modale (funziona sia su index che su catalogo)
...
/* ══════════════════════════════════════════════════════════
   WORKSHOP: eventi in programma (Solo Index)
   ══════════════════════════════════════════════════════════ */
